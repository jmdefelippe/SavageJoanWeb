export const styles = {
    header: `flex flex-wrap px-4 py-5 bg-red-600`,
    headerLinkActive: `text-white text-sm font-bold px-10 underline block hover:text-black`,
    headerLinkInactive: `text-white text-sm font-bold px-10 block hover:text-black`,
